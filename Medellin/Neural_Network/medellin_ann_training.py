...
# Predict
result_all_data = model_all_data.predict(X_val_all_data)
result_all_data = result_all_data.reshape(93076, )
...
# Predict
result_relevant = model_relevant.predict(X_val_relevant)
result_relevant = result_relevant.reshape(93076, )
